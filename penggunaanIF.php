...
<head>
    ...
    <title>Nilai akhir dan Grade</title>
</head>
<body>
    <table>
        <tr>
            <td>
                <div>
                    <h2>Menghitung<br> Nilai akhir dan <br> Keterangan grade</h2>
            ...
            <td>
            <?php
            if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['nama']) && isset($_POST['nim']) && isset($_POST['matakuliah']) && isset($_POST['kehadiran']) && isset($_POST['tugas']) && isset($_POST['uts']) && isset($_POST['uas'])) {
                $nama = $_POST["nama"];
                $nim = $_POST["nim"];
